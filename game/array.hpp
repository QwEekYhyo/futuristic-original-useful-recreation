...
public:
  ...
  reference operator[](size_type n) noexcept { return m_buffer[n]; }

  const_reference operator[](size_type n) const noexcept { return m_buffer[n]; }

  reference front() noexcept { return m_buffer[0]; }

  const_reference front() const noexcept { return m_buffer[0]; }

  reference back() noexcept { return m_buffer[N - 1]; }

  const_reference back() const noexcept { return m_buffer[N - 1]; }
